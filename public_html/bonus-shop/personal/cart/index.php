...
?>
    ...
    $APPLICATION->IncludeComponent("bitrix:sale.basket.basket", "bootstrap_bonus", array(
            ...
            "EMPTY_BASKET_HINT_PATH" => "/bonus-shop/index.php#lab-catalog",    // Путь к странице для продолжения покупок
    ...
    <? $APPLICATION->IncludeComponent(
            ...
            array(
                    ...
                    "EMPTY_BASKET_HINT_PATH" => "/bonus-shop/index.php#lab-catalog",
